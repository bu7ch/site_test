...
ActiveRecord::Schema.define(version: 20140729192605) do

  create_table "accroche_homes", force: true do |t|
    t.text "content"
  end
  ...
  create_table "item_menu_articles", force: true do |t|
